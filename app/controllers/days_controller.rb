class DaysController < ApplicationController
  ...
  def update
    ...
    (0..num_proj_codes-1).each do |i|
      @allocations << Allocation.new(project_code:params_proj_codes["project_code_#{i}_name"], percentage:params_proj_codes["project_code_#{i}_perc"], day_id: @day.id) unless params_proj_codes["project_code_#{i}_perc"] == ""
    end
